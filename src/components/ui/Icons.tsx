...
export const Icons = {
  Leaf: ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg className={className} viewBox="0 0 32 32" fill="none">
      <path d="M16 4C16 4 8 8 8 18C8 24 12 28 16 28C20 28 24 24 24 18C24 8 16 4 16 4Z" fill="currentColor" opacity="0.2"/>
      <path d="M16 4C16 4 8 8 8 18C8 24 12 28 16 28C20 28 24 24 24 18C24 8 16 4 16 4Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  ...
  Receipt: ({ className = "w-5 h-5" }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  Pound: ({ className = "w-5 h-5" }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
  ),
  // NEW ICONS FOR AUTH PAGES
  ...
  Monitor: ({ className = "w-5 h-5" }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  FileCheck: ({ className = "w-5 h-5" }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V18a2 2 0 01-2 2z" />
    </svg>
  ),
  ...
  Percent: ({ className = "w-5 h-5" }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 5L5 19M9 7a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z" />
    </svg>
  ),
};
...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-sage-600 text-white hover:bg-sage-700 disabled:bg-sage-300',
...
export const Card: React.FC<CardProps> = ({ children, className = '', padding = 'md' }) => {
  ...
  return (
    <div className={`bg-white rounded-xl shadow-soft ${paddings[padding]} ${className}`}>
      {children}
    </div>
  );
};
...
interface BadgeProps {
  children: React.ReactNode;
  variant?: 'sage' | 'amber' | 'blue' | 'red' | 'gray';
}
  ...
  return (
    <Card>
      <div className="flex items-start justify-between">
        ...
        {icon && <div className="text-sage-600">{icon}</div>}
      </div>
    </Card>
  );
};
...
export const Avatar: React.FC<AvatarProps> = ({ name, size = 'md', src }) => {
  ...
  return (
    <div className={`${sizes[size]} rounded-full bg-sage-100 text-sage-700 flex items-center justify-center font-medium`}>
      {initials}
    </div>
  );
};
