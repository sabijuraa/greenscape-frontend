...
export const Icons = {
  ...
  Layers: ({ className = "w-5 h-5" }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 3L2 9l10 6 10-6-10-6zM2 17l10 6 10-6M2 12l10 6 10-6" />
    </svg>
  ),
  ...
  Truck: ({ className = "w-5 h-5" }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 17h8M8 17a2 2 0 11-4 0m4 0a2 2 0 10-4 0m12 0a2 2 0 11-4 0m4 0a2 2 0 10-4 0M3 8h10a1 1 0 011 1v6H4a1 1 0 01-1-1V8zm11 0h4l3 4v3h-7V8z" />
    </svg>
  ),
...
export const Card: React.FC<CardProps> = ({ children, className = '', padding = 'md', onClick }) => {
  ...
  return (
    <div 
      className={`bg-white rounded-xl shadow-soft ${paddings[padding]} ${className}`}
      onClick={onClick}
    >
      {children}
    </div>
